  ...
  <div class="datatable-container">
      ...
      <DataTable 
        ...
        >
          ...
          <Column header="Items" style="height: 44px">
            <template #body="{ data }">
              {{ data.items?.length > 0 ? showItems(data.items) : 'No Items' }}
            </template>
          </Column>
...
<script setup>
  ...
  async function loadLazyAreas(event, queryParams = {}){
