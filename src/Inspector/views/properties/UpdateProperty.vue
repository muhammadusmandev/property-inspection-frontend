...
<script setup lang="ts">
  ...
  import { getProperty, updateProperty, getInspectorClients, getInspectorBranches, deleteProperty } from '@/services/api'
  ...
  const { data: clientsData, execute: execute2 } = useApi(getInspectorClients, false)
  const { data: branchesData, execute: execute3 } = useApi(getInspectorBranches, false)
